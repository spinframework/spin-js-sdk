declare module 'fermyon:spin/llm@2.0.0' {
   ...
   */
  export function infer(model: InferencingModel, prompt: string, params: InferencingParams | undefined): InferencingResult;
  /**
   * Generate embeddings for the supplied list of text
   */
  export function generateEmbeddings(model: EmbeddingModel, text: Array<string>): EmbeddingsResult;
  /**
   ...
   */
  export type Error = ErrorModelNotSupported | ErrorRuntimeError | ErrorInvalidInput;
