declare module 'spin:postgres/postgres@3.0.0' {
   ...
   * ## `"other"`
   */
  export type DbDataType = 'boolean' | 'int8' | 'int16' | 'int32' | 'int64' | 'floating32' | 'floating64' | 'str' | 'binary' | 'date' | 'time' | 'datetime' | 'timestamp' | 'other';
  /**
   * Database values
   */
  export type DbValue = DbValueBoolean | DbValueInt8 | DbValueInt16 | DbValueInt32 | DbValueInt64 | DbValueFloating32 | DbValueFloating64 | DbValueStr | DbValueBinary | DbValueDate | DbValueTime | DbValueDatetime | DbValueTimestamp | DbValueDbNull | DbValueUnsupported;
