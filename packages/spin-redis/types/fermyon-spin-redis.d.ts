declare module 'fermyon:spin/redis@2.0.0' {
   ...
   */
  export type Error = ErrorInvalidAddress | ErrorTooManyConnections | ErrorTypeError | ErrorOther;
  /**
  ...
  export class Connection {
    ...
    */
    execute(command: string, arguments: Array<RedisParameter>): Array<RedisResult>;
  }
