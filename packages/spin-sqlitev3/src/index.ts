import * as spinSqlite from 'spin:sqlite/sqlite@3.0.0';
...
export interface SqliteConnection {
  ...
  /**
   * Returns the row ID of the last inserted row of the most recent successful
   * INSERT operation on the connection or 0 if no such operation has occurred.
   * @returns {bigint}
   */
