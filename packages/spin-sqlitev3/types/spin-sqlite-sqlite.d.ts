declare module 'spin:sqlite/sqlite@3.0.0' {
  /**
   * The set of errors which may be raised by functions in this interface
   */
  export type Error = ErrorNoSuchDatabase | ErrorAccessDenied | ErrorInvalidConnection | ErrorDatabaseFull | ErrorIo;
  /**
   ...
   */
  export type Value = ValueInteger | ValueReal | ValueText | ValueBlob | ValueNull;
