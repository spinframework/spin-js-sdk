...
describe('readPackageJson', () => {
  ...
  it('should return parsed JSON if package.json exists', () => {
    ...
    expect(readPackageJson('/path/to/package.json')).to.deep.equal({
      name: 'test-package',
    });
  });
});
...
describe('resolveDependencyPath', () => {
  ...
  it('should return node_modules path if dependency exists', () => {
    existsSyncStub.returns(true);
    expect(resolveDependencyPath('/project', 'dep')).to.equal(
...
describe('getPackagesWithWasiDeps (recursive)', () => {
  ...
  it('should collect dependencies recursively that contain a wasiDep config', async () => {
    ...
    readFileSyncStub
      .withArgs('/project/package.json')
      .returns(JSON.stringify(packageJson1));

    existsSyncStub.withArgs('/project/node_modules/package-2').returns(true);
    existsSyncStub
      .withArgs('/project/node_modules/package-2/package.json')
      .returns(true);
    readFileSyncStub
      .withArgs('/project/node_modules/package-2/package.json')
      .returns(JSON.stringify(packageJson2));

    existsSyncStub.withArgs('/project/node_modules/package-3').returns(true);
    existsSyncStub
      .withArgs('/project/node_modules/package-3/package.json')
      .returns(true);
    readFileSyncStub
      .withArgs('/project/node_modules/package-3/package.json')
      .returns(JSON.stringify(packageJson3));

    existsSyncStub
      .withArgs('/project/node_modules/package-2/node_modules/package-4')
      .returns(true);
    existsSyncStub
      .withArgs(
        '/project/node_modules/package-2/node_modules/package-4/package.json',
      )
      .returns(true);
    readFileSyncStub
      .withArgs(
      ...
      .returns(JSON.stringify(packageJson4));

    existsSyncStub.withArgs('/project/node_modules/package-5').returns(true);
    existsSyncStub
      .withArgs('/project/node_modules/package-5/package.json')
      .returns(true);
    readFileSyncStub
      .withArgs('/project/node_modules/package-5/package.json')
      .returns(JSON.stringify(packageJson5));
